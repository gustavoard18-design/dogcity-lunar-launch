...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'collector_6', title: L({ en: 'Collector', pt: 'Colecionador', es: 'Coleccionista' }), description: L({ en: 'Own 6 Shop items', pt: 'Tenha 6 itens da Loja', es: 'Ten 6 objetos de la Tienda' }), icon: 'capacete', target: 6, progress: p => p.ownedCosmetics.length, reward: { stardust: 150, lunarDust: 3 } },
